...
class LeftPanel {
  constructor(h){
    ...
    this.links = [
      { label: "泡泡爆破", url: "https://ww924736-oss.github.io/20251014./" },
      { label: "作品筆記", url: "https://hackmd.io/@gxxE19UKS8iSRPcLsyjtmQ/H1KxFuJ2gl" },
      { label: "小測驗", url: "https://ww924736-oss.github.io/20251110/" },
  ...
  show(){
    ...
    for (let i = 0; i < this.links.length; i++){
        ...
        // 根據懸停狀態設定文字大小與顏色
        let currentSize = this.textSize;
        if (isHovered) {
            fill(255, 0, 0);        // 懸停時改為紅色
            currentSize = this.textSize * 1.3; // 放大 30%
        } else {
